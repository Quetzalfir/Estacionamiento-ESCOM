...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2018 a las 20:14:41
...
('admin', 'Juan', 'Parades', 'Aguilar', '558478865', 'juanpa@gmail.com', '6548646213', 'Admin', 'admin', '2018-11-26', 1, NULL),
('vladimirah', 'Vladimir', 'Azpeitia', 'Hernandez', '5521054892', 'vladimir@hotmail.com', '2017350201', 'Alumno', 'qwerty', '2018-11-27', 0, NULL);
...
ALTER TABLE `tb_reporte`
  ADD PRIMARY KEY (`noReporte`,`IDConductor`),
